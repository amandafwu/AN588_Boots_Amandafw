---
title: "Amandafw_FinalHomeworkCode_05"
author: "Amanda Wu"
date: "2023-11-21"
...
se_b <- apply(boot_results$t, 2, sd) # prints the SE of the coefficients
se_b
...
### Challenges: 
  + I didn't face too many challenges with this homework assignment but I did do part of the assignment incorrectly, as pointed out by Juli, so she gave me advice on how to get the correct values. I struggled a little with making the bootstrapped values but I was able to google how to get these values and I was able to find a website that gave me step-by-step instructions on how to do bootstrapping. 