...
The estimated 95% CI values for the dataset and the bootstrapped sampling distribution are super close to each other but the SE values appears to be different. However, this may be due to the fact that 
